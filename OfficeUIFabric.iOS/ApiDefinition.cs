...
namespace OfficeUIFabric.iOS
{
    ...
    interface MSBadgeField
    {
        ...
        [Wrap("WeakDelegate")]
        [NullAllowed]
        MSBadgeFieldDelegate Delegate { get; set; }
    ...
    // @interface OfficeUIFabric_Swift_425 (MSBadgeField) <MSBadgeViewDelegate>
    [Category]
    [BaseType(typeof(MSBadgeField))]
    interface MSBadgeField_OfficeUIFabric_Swift_425 : IMSBadgeViewDelegate
    {
    ...
    // @interface OfficeUIFabric_Swift_432 (MSBadgeField) <UITextFieldDelegate>
    [Category]
    [BaseType(typeof(MSBadgeField))]
    interface MSBadgeField_OfficeUIFabric_Swift_432 : IUITextFieldDelegate
    {
    ...
    interface MSBadgeFieldDelegate
    {
        ...
        void BadgeField(MSBadgeField badgeField, string newText);
        ...
        void DidDeleteBadgeField(MSBadgeField badgeField, MSBadgeView badge);
        ...
        MSBadgeView BadgeField(MSBadgeField badgeField, MSBadgeViewDataSource badgeDataSource);
        ...
        bool ShouldDragBadgeField(MSBadgeField badgeField, MSBadgeView badge);
    ...
    // @interface OfficeUIFabric_Swift_801 (MSDrawerController) <UIPopoverPresentationControllerDelegate>
    [Category]
    [BaseType(typeof(MSDrawerController))]
    interface MSDrawerController_OfficeUIFabric_Swift_801 : IUIPopoverPresentationControllerDelegate
    {
    ...
    // @interface OfficeUIFabric_Swift_807 (MSDrawerController) <UIViewControllerTransitioningDelegate>
    [Category]
    [BaseType(typeof(MSDrawerController))]
    interface MSDrawerController_OfficeUIFabric_Swift_807 : IUIViewControllerTransitioningDelegate
    {
    ...
    // @interface OfficeUIFabric_Swift_943 (MSPageCardPresenterController) <UIViewControllerTransitioningDelegate>
    [Category]
    [BaseType(typeof(MSPageCardPresenterController))]
    interface MSPageCardPresenterController_OfficeUIFabric_Swift_943 : IUIViewControllerTransitioningDelegate
    {
        // -(id<UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForPresentedController:(UIViewController * _Nonnull)presented presentingController:(UIViewController * _Nonnull)presenting sourceController:(UIViewController * _Nonnull)source __attribute__((warn_unused_result));
        [Export("animationControllerForPresentedController:presentingController:sourceController:")]
        [return: NullAllowed]
    ...
    // @interface OfficeUIFabric_Swift_951 (MSPageCardPresenterController) <UIScrollViewDelegate>
    [Category]
    [BaseType(typeof(MSPageCardPresenterController))]
    interface MSPageCardPresenterController_OfficeUIFabric_Swift_951 : IUIScrollViewDelegate
    {
    ...
    */
    ...
    [DisableDefaultCtor]
    interface MSPersonaData : IMSPersona
    {
    ...
    // @interface OfficeUIFabric_Swift_1124 (MSPersonaListView) <UITableViewDelegate>
    [Category]
    [BaseType(typeof(MSPersonaListView))]
    interface MSPersonaListView_OfficeUIFabric_Swift_1124 : IUITableViewDelegate
    {
    ...
    // @interface OfficeUIFabric_Swift_1130 (MSPersonaListView) <UITableViewDataSource>
    [Category]
    [BaseType(typeof(MSPersonaListView))]
    interface MSPersonaListView_OfficeUIFabric_Swift_1130 : IUITableViewDataSource
    {
    ...
    // @interface OfficeUIFabric_Swift_1181 (MSPopupMenuController) <UIGestureRecognizerDelegate>
    [Category]
    [BaseType(typeof(MSPopupMenuController))]
    interface MSPopupMenuController_OfficeUIFabric_Swift_1181 : IUIGestureRecognizerDelegate
    {
    ...
    // @interface OfficeUIFabric_Swift_1186 (MSPopupMenuController) <UITableViewDataSource>
    [Category]
    [BaseType(typeof(MSPopupMenuController))]
    interface MSPopupMenuController_OfficeUIFabric_Swift_1186 : IUITableViewDataSource
    {
        // -(NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView __attribute__((warn_unused_result));
        [Export("numberOfSectionsInTableView:")]
        nint NumberOfSectionsInTableView(UITableView tableView);
    ...
    // @interface OfficeUIFabric_Swift_1193 (MSPopupMenuController) <UITableViewDelegate>
    [Category]
    [BaseType(typeof(MSPopupMenuController))]
    interface MSPopupMenuController_OfficeUIFabric_Swift_1193 : IUITableViewDelegate
    {
        ...
        [return: NullAllowed]
        UIView ViewFormHeaderInSection(UITableView tableView, nint section);

        // -(NSIndexPath * _Nullable)tableView:(UITableView * _Nonnull)tableView willSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath __attribute__((warn_unused_result));
        [Export("tableView:willSelectRowAtIndexPath:")]
        [return: NullAllowed]
        NSIndexPath WillSelectRowAtIndex(UITableView tableView, NSIndexPath indexPath);

        // -(void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
        [Export("tableView:didSelectRowAtIndexPath:")]
        void DidSelectRowAtIndex(UITableView tableView, NSIndexPath indexPath);
    }
